...
class Motor_Controller():
    def __init__(self):
        ...
        self.yaw_setpoint_pub = rospy.Publisher('pid/yaw/setpoint',Float64,queue_size=1)
        self.yaw_setpoint_pub_data = Float64()
        self.roll_setpoint_pub = rospy.Publisher('pid/roll/setpoint',Float64,queue_size=1)
        self.roll_setpoint_pub_data = Float64()
        self.pitch_setpoint_pub = rospy.Publisher('pid/pitch/setpoint',Float64,queue_size=1)
        self.pitch_setpoint_pub_data = Float64()
        self.depth_setpoint_pub = rospy.Publisher('pid/depth/setpoint',Float64,queue_size=1)
        self.depth_setpoint_pub_data = Float64()
        self.drive_setpoint_pub = rospy.Publisher('pid/drive/setpoint',Float64,queue_size=1)
        self.drive_setpoint_pub_data = Float64()
        self.strafe_setpoint_pub = rospy.Publisher('pid/strafe/setpoint',Float64,queue_size=1)
