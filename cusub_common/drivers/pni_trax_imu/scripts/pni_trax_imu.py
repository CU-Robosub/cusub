  ...
  0, 0,   1e2]
        ...
        while 1:
            ...
            if ord(f[0]) == 5:   # kGetDataResp has frameID = 5
                ...
                self.pub_data.angular_velocity.x = -data[15]
                self.pub_data.angular_velocity.y = data[13]
                self.pub_data.angular_velocity.z = data[11]
                ...
                self.pub_data.linear_acceleration.x = -data[23]*9.8
                self.pub_data.linear_acceleration.y = data[25]*9.8
                self.pub_data.linear_acceleration.z = data[27]*9.8

                # print x:data[23] y:data[25] z:data[27]
