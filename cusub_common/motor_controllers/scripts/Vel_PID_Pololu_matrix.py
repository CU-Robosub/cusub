...
class PID_Pololu():
    ...
    def __init__(self):
        ...
        self.drive_sub = rospy.Subscriber('cusub_common/motor_controllers/mux/drive_vel/control_effort',
                                          Float64, self.drive_callback)
        ## Subscriber for the strafe pid topic
        self.strafe_sub = rospy.Subscriber('cusub_common/motor_controllers/mux/strafe_vel/control_effort',
