...
class Test:   
    ...
    condition = bt.Condition("move_condition", 'should_move')
    sequence = bt.Sequence("move", True)
    move1 = bt.Move("move_forward", 'position')
    move2 = bt.Move("move_backward", 'position')

    move3 = bt.Move("return_to_start", 'position')
